...
function showGate(){
  ...
  gate.id = 'access-gate';
  gate.style.cssText = 'visibility:visible;position:fixed;top:0;left:0;width:100%;height:100%;background:#FFF7FA;z-index:99999;display:flex;align-items:center;justify-content:center;font-family:Manjari,system-ui,sans-serif';
  gate.innerHTML = `
    <div style="visibility:visible;background:#FFFCE8;border:1.5px solid #D4B896;border-radius:16px;padding:2rem;width:88%;max-width:340px;text-align:center;box-shadow:0 8px 32px rgba(0,0,0,.08)">
